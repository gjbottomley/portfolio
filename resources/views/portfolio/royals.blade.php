  ...
  <section class="container container--portfolio">
    ...
    <div class="content center">
      ...
      <div class="button-wrapper">
        <a href="https://www.royalsshoppingcentre.co.uk/" target="_blank" class="button button--blue button--space" title="View Royals Shopping Centre">View Royals Shopping Centre</a>
      </div>
    </div>
    <div class="content">
