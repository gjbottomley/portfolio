...
@section('content')
  <section class="container container--portfolio">
    <div class="site-wrapper">
      <img src="{{ url('images/portfolio/seetec/seetec-website.jpg') }}">
    </div>
    <div class="content center">
      <div class="content__text content__text--portfolio">
        <ul>
          <li><b>Job Role:</b> Lead Frontend Developer</li>
          <li><b>Website Description:</b> Apprenticeships and career building</li>
        </ul>
      ...
      <div class="button-wrapper">
        <a href="https://www.seetec.co.uk/" target="_blank" class="button button--blue button--space" title="View Seetec">View Seetec</a>
      </div>
    </div>
    <div class="content">
