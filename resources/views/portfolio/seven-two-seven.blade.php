...
@section('content')
  <section class="container container--portfolio">
    <div class="site-wrapper">
      <img src="{{ url('images/portfolio/seventwoseven/website.jpg') }}">
    </div>
    <div class="content center">
      <div class="content__text content__text--portfolio">
        <ul>
          <li><b>Job Role:</b> Lead Frontend Developer</li>
          <li><b>Website Description:</b> Architectural design</li>
        </ul>
      ...
      <div class="button-wrapper">
        <a href="https://www.seventwoseven.co.uk/" target="_blank" class="button button--blue button--space" title="View Seven Two Seven">View Seven Two Seven</a>
      </div>
    </div>
    <div class="content">
