...
@section('content')
  <section class="container container--portfolio">
    <div class="site-wrapper">
      <img src="{{ url('images/portfolio/generational/website.jpg') }}">
    </div>
    <div class="content center">
      <div class="content__text content__text--portfolio">
        <ul>
          <li><b>Job Role:</b> Lead Frontend Developer</li>
          <li><b>Website Description:</b> Selling your Business</li>
        </ul>
      ...
      <div class="button-wrapper">
        <a href="https://www.genequityco.com/" target="_blank" class="button button--blue button--space" title="View Generational Equity">View Generational</a>
      </div>
    </div>
    <div class="content">
