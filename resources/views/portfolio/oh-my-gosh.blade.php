...
@section('content')
  <section class="container container--portfolio">
    <div class="site-wrapper">
      <img src="{{ url('images/portfolio/oh-my-gosh/website.jpg') }}">
    </div>
    <div class="content center">
      <div class="content__text content__text--portfolio">
        <ul>
          <li><b>Job Role:</b> Lead Frontend Developer</li>
          <li><b>Website Description:</b> Charity initiative in Essex</li>
        </ul>
      ...
      <div class="button-wrapper">
        <a href="http://www.ohmygosh.org.uk/" target="_blank" class="button button--blue button--space" title="View Oh My Gosh!">View Oh My Gosh</a>
      </div>
    </div>
    <div class="content">
