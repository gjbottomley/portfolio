...
@section('content')
  <section class="container container--portfolio">
    <div class="site-wrapper">
      <img src="{{ url('images/portfolio/method/website.jpg') }}">
    </div>
    <div class="content center">
      <div class="content__text content__text--portfolio">
        <ul>
          <li><b>Job Role:</b> Lead Frontend Developer</li>
          <li><b>Website Description:</b> Strategic IT support</li>
        </ul>
      ...
      <div class="button-wrapper">
        <a href="https://www.method-it.co.uk/" target="_blank" class="button button--blue button--space" title="View Method IT">View Method IT</a>
      </div>
    </div>
    <div class="content">
