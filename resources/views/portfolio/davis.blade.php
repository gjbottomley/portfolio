  ...
  <section class="container container--portfolio">
    ...
    <div class="content center">
      ...
      <div class="button-wrapper">
        <a href="https://www.davisconstruction.co.uk/" target="_blank" class="button button--blue button--space" title="View Davis Construction">View Davis Construction</a>
      </div>
    </div>
    <div class="content">
