...
@section('content')
  <section class="container container--portfolio">
    <div class="site-wrapper">
      <img src="{{ url('images/portfolio/holmes/website.jpg') }}">
    </div>
    <div class="content center">
      <div class="content__text content__text--portfolio">
        <ul>
          <li><b>Job Role:</b> Lead Frontend Developer</li>
          <li><b>Website Description:</b> Residential Development</li>
        </ul>
      ...
      <div class="button-wrapper">
        <a href="http://www.holmesholmes.com/" target="_blank" class="button button--blue button--space" title="View Holmes Holmes">View Holmes Holmes</a>
      </div>
    </div>
    <div class="content">
